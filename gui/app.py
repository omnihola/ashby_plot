...
class AshbyPlotApp:
    ...
    def create_variables(self):
        ...
        variables = {
            ...
            'data_type': tk.StringVar(value="ranges"),
    ...
    def create_layout(self):
        ...
        # Add tabs
        file_panel = FilePanel(notebook, self.variables, self.refresh_plot)
        axis_panel = AxisPanel(notebook, self.variables)
        ...
        notebook.add(axis_panel, text="Axis Settings")
